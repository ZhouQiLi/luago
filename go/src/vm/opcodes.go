...
var opcodes = []opcode{
	...
	{0, 1, OpArgR, OpArgN, IABC, "LEN       ", valueLength},
	{0, 1, OpArgR, OpArgR, IABC, "CONCAT    ", concat},
	{0, 0, OpArgR, OpArgN, IAsBx, "JMP       ", jump},
